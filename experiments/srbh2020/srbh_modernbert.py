...
def run_experiment(
        ...
        dataset_prefix="standard-mlm-modernebert",
        do_preprocess=False,
        do_split=False,
        do_train=True,
        do_test=True,
    ...
    execute(
        ...
        do_train_finetuning=do_train,
        do_predict=do_test,
        do_evaluate=do_val,
        train_finetuning_args={
            "learning_rate": 8e-5,
    ...
    generic_title = f"f {base_model} SRBH mlm"
    ...
    if do_plot:
        ...
        results_based_on_class_plot(
            ...
            TRUTH_DATASET_PATH,
            plot=True,
            title="SRBH mlm evaluation: False Negatives by anomaly class"
        )
